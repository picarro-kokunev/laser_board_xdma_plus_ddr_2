...
--               /home/kokunev/data/git_root/laser_board_xdma_plus_ddr/project_1/project_1.gen/sources_1/bd/design_1/ip/design_1_util_ds_buf_0_0/design_1_util_ds_buf_0_0_sim_netlist.vhdl
...
entity design_1_util_ds_buf_0_0_util_ds_buf is
  ...
  attribute C_DIVBY2 of design_1_util_ds_buf_0_0_util_ds_buf : entity is 1;
...
architecture STRUCTURE of design_1_util_ds_buf_0_0_util_ds_buf is
  ...
  signal \USE_IBUFDS_GTE2.IBUF_OUT_N\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \USE_IBUFDS_GTE2.IBUF_OUT_P\ : STD_LOGIC_VECTOR ( 0 to 0 );
...
\USE_IBUFDS_GTE2.GEN_IBUFDS_GTE2[0].IBUFDS_GTE2_I\: unisim.vcomponents.IBUFDS_GTE2
    generic map(
      ...
      CLKSWING_CFG => B"11"
        ...
        port map (
      CEB => \<const0>\,
      I => \USE_IBUFDS_GTE2.IBUF_OUT_P\(0),
      IB => \USE_IBUFDS_GTE2.IBUF_OUT_N\(0),
      O => IBUF_OUT(0),
...
\USE_IBUFDS_GTE2.GEN_IBUFDS_GTE2[0].IBUF_N_I\: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => IBUF_DS_N(0),
      O => \USE_IBUFDS_GTE2.IBUF_OUT_N\(0)
    );
\USE_IBUFDS_GTE2.GEN_IBUFDS_GTE2[0].IBUF_P_I\: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => IBUF_DS_P(0),
      O => \USE_IBUFDS_GTE2.IBUF_OUT_P\(0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity design_1_util_ds_buf_0_0 is
  ...
  attribute x_core_info of design_1_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2025.2";
...
architecture STRUCTURE of design_1_util_ds_buf_0_0 is
  ...
  attribute C_DIVBY2 : integer;
  attribute C_DIVBY2 of U0 : label is 1;
  attribute C_MODE : string;
