...
design_libs=(xilinx_vip xpm xil_defaultlib proc_sys_reset_v5_0_17 blk_mem_gen_v8_4_12 fifo_generator_v13_2_14 xdma_v4_2_2)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/d6c9/hdl/verilog" +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/d6c9/hdl/verilog" +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/d6c9/hdl/verilog" +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/d6c9/hdl/verilog" +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_14 $vlogan_opts +v2k +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/d6c9/hdl/verilog" +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xdma_v4_2_2 $vlogan_opts -sverilog +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/d6c9/hdl/verilog" +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  "../../../../project_1.gen/sources_1/bd/design_1/ipshared/d6c9/hdl/xdma_v4_2_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/d6c9/hdl/verilog" +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
