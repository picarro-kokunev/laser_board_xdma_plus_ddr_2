...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L xdma_v4_2_2"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L blk_mem_gen_v8_4_12 -L fifo_generator_v13_2_14 -L xdma_v4_2_2 -L generic_baseblocks_v2_1_2 -L axi_data_fifo_v2_1_36 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_protocol_converter_v2_1_37 -L axi_clock_converter_v2_1_35 -L axi_dwidth_converter_v2_1_37 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
